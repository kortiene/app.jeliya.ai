...
| Direct network behavior | signed runs certify released `v0.5.0`, the prior `55024a4…` + `71fbb500…` snapshot, and the current `922f620…` + `a5d98b70…` pair (direct run `098c4979`, operator linux arm64) | rerun the source-built forced-relay qualification at `922f620…` + `a5d98b70…` | verification owner | direct qualified at `922f620…` + `a5d98b70…`; forced relay still pending |
