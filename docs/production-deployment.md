...
- load tests at the profile in the [relay load-and-cost-ceilings record](relay-load-and-cost-ceilings-decision.md) stay within its published egress, request, and spend ceilings;
