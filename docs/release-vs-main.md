...
| Current `v0.6.0` source candidate | `922f620b30ee95c82426a7d4404b1f73a70c0958` (tip of public `main`; `105744b…` plus merged pull requests #1 and #58) | pins untagged public Iroh Rooms `a5d98b70d717f35d3ce60953a88e12e646f2e871`, the first merge carrying `kortiene/iroh-room#121` and `kortiene/iroh-room#119` fixes plus the `kortiene/iroh-room#126` follow-ups | exact-revision upstream, workspace, and 67-assertion loopback suites pass locally at this revision; a hosted CI run at this revision is still in progress; fresh signed direct/relay evidence pending | locally qualified; not network-qualified or published |
