...
bind the current candidate `922f620…` + published pin `a5d98b70…`, carry
detached Ed25519 signatures, and set `certifiable: true`. Together they qualify
the current source candidate; the release evidence gate is READY for that pair.
